...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps
                         .Where((emp) => emp.Salary == (Emps.Max(empl => empl.Salary)));
        }
...

        {
            ...
            var res = Emps
                ...
                .Union(Emps
                    .Where(emp => emp.Ename == "Brak wartosci" || emp.Job == null || emp.HireDate == null)
                    .Select(emp =>
                    new
                    {
                        emp.Ename,
        ...
        {
            var maxSal = Emps
                .Aggregate(0, (maxP, next) =>
                         (next.Salary >= maxP ? maxP = next.Salary : maxP));

            var res = Emps
                .Where((emp) => emp.Salary == maxSal)
                .Select(emp =>
               new
               {
                   emp.Ename,
